...
public class GTv1 {
	...
	public void testCreatesNextDate3() throws Throwable {
	    ...
	    String string0 = nextDate0.run(4, 4, 1905);
	    assertEquals("4/5/1905", string0);
	}
	...
	public void testCreatesNextDate4() throws Throwable {
	    ...
	    String string0 = nextDate0.run(11, 30, 1898);
	    assertEquals("12/1/1898", string0);
	}
	...
	public void testCreatesNextDate13() throws Throwable {
	    NextDate nextDate0 = new NextDate(2, 2, 2);
	    String string0 = nextDate0.run(6, 6, 1903);
	    assertEquals("6/7/1903", string0);
	}
	...
	public void testCreatesNextDate9() throws Throwable {
	    NextDate nextDate0 = new NextDate(2, 2, 2);
	    String string0 = nextDate0.run(2, 29, 1962);
	    assertEquals("Invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate11() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 31, 1969);
	    assertEquals("6/1/1969", string0);
	}
